...
# Load VGG16 dengan pre-trained weights dari ImageNet
base_model = VGG16(weights="imagenet", include_top=False, input_shape=(128, 128, 3))

# Bekukan sebagian layer awal VGG16 agar tidak berubah saat training
...
# Data augmentation untuk training & validasi
...
model.save(os.path.join(model_dir, "VGG16.h5"))
print("Model VGG16 telah disimpan di 'model/VGG16.h5'")
...
plt.savefig(os.path.join(static_images_dir, 'training_validation_graphs_vgg.png'))
plt.close()
...
plt.savefig(os.path.join(static_images_dir, 'confusion_matrix_vgg.png'))
plt.close()
...
plt.savefig(os.path.join(static_images_dir, 'roc_curve_vgg.png'))
plt.close()
